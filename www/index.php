...
$form -> addElement('text', 'login', _LOGIN, 'class = "inputText" id = "login_box" placeholder="E-mail Address"');
...
$form -> addElement('password', 'password', _PASSWORD, 'class = "inputText" tabindex = "0" placeholder="Password"');
$form -> addRule('password', _THEFIELD.' "'._PASSWORD.'" '._ISMANDATORY, 'required', null, 'client');

$form -> addElement('checkbox', 'remember', _KEEPMELOGGEDIN, null, 'class="hno-radiobtn" id="rad1"');
$form -> addElement('submit', 'submit_login', 'SIGN IN', 'class="ybtn ybtn-accent-color"');
...
//var_dump($smarty->get_template_vars());exit;
